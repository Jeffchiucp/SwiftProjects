...
// 3) answer If your two points are a and b, the formula is sqrt((b.x - a.x)*(b.x - a.x) + (b.y - a.y)*(b.x - a.y)). Use this to get the length
import Foundation
...
// Formulaa sqrt((b.x - a.x)*(b.x - a.x) + (b.y - a.y)*(b.x - a.y)). Use this to get the length
