...
//use var. The number of cars in the lot will change throughout the day. Using let here would not allow new cars to park or allow people to retrieve cars already parked.
