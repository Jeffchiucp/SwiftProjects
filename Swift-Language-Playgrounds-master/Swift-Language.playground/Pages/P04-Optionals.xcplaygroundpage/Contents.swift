...
// Swift expects you to instantiate that
// when you create a new task, you must have something new.
// three way to expects you to add a free way
...
// by default, just do this. nil
var myString : String? = "abc"

var newString = myString ?? "do this"
