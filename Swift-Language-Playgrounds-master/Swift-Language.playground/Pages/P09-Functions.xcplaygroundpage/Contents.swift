...
func getAreaWithHeight(height: Int, width: Int) -> Int {
    return height * width
}

getAreaWithHeight(10, width: 12)
...
//call the function for height: 8
getArea(8, width: 25)


// 2  calculate perimiter. 2h + 2w. Contractors would use this to caluclate how much molding or framing material might be needed. Remember, perimeter is calculated as the sum of all sides.
