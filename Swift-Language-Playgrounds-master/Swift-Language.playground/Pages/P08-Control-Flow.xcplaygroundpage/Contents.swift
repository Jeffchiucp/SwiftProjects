...
// Write your challenge code here:
 ...
 // 1 Creat an Array for instructors, including these: Daniel, Martin, Stephen, Ann, Adam, Dion, Mike
var instructors = ["Daniel", "Martin", "Stephen", "Ann", "Adam", "Dion", "Mike", "Steve", "Ann", "Ali", "etc"]
 for instructor in instructors {
 print(instructor)
 }
 
 // 2 (Hint: you can use hasPrefix(), something like: name.hasPrefix("D")). Add each instructor you found to a new array and print that array after the loop to check your answer.
 ...
 // 3 Create a loop that will stop after it finds "Frango". Hint: you can use break to stop a loop early! Print a message stating that you have found "Frango".
 ...
 // 5 When x is less than 0 or when the x is greater than 375, velocity needs to be inverted. For example if volicity was 10 and the x position of the object was 380 velocity would become -10. Recreate the example in code. Print velocity to show that it has changed to -10.
